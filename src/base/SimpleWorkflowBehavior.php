...
class SimpleWorkflowBehavior extends Behavior
{
	 ...
	 * configured.
	 */
	const DEFAULT_SOURCE_CLASS = 'jinowom\workflow\source\file\WorkflowFileSource';
	/**
	 * Name of the class used to instantiate the default event sequence if not 
	 * configured.
	 */
	const DEFAULT_EVENT_SEQUENCE_CLASS = 'jinowom\workflow\events\BasicEventSequence';
	/**
	 ...
	 * `jinowom\workflow\base\IStatusIdConverter` interface.
	 */	
	 ...
	 * `jinowom\workflow\base\IStatusAccessor` interface.
	 */	
	 ...
	 *
	 * @see http://www.yiiframework.com/doc-2.0/yii-base-behavior.html#attach()-detail
	 * @see initStatus()
	 */
	 ...
	 * 
	 * @throws \jinowom\workflow\base\WorkflowException if the status attribute could not be converted into a Status object
	 */
	 ...
	 * - index = 1 : an array of [[\jinowom\workflow\events\WorkflowEvent]] instances (the event sequence) that 
	 ...
	 * 
	 * @return \jinowom\workflow\source\IWorkflowSource the workflow source component instance used by this behavior
	 */
	 ...
	 * @return NULL|\jinowom\workflow\base\IStatusAccessor the status accessor component used bu the behavior
