 ...
 * source access.
 *
 * @see \jinowom\workflow\base\WorkflowBaseObject
 */
class Workflow extends WorkflowBaseObject implements WorkflowInterface
{
	...
	/**
	 * @see \jinowom\workflow\base\WorkflowInterface::getInitialStatusId()
	 */
	...
	/**
	 * @see \jinowom\workflow\base\WorkflowInterface::getInitialStatus()
	 */
	...
	/**
	 * @see \jinowom\workflow\base\WorkflowInterface::getAllStatuses()
	 */
