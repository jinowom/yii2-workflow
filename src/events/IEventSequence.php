 ...
 * key, the value is an array of `\jinowom\workflow\events\WorkflowEvent` representing the sequence of event
 * to fire *before* or *after* the workflow event occurs.
 *
 * Two event sequences implementations are provided :
 *
 * - {@link \jinowom\workflow\events\BasicEventSequence}
 * - {@link \jinowom\workflow\events\ExtendedEventSequence}
 */
interface IEventSequence
{
	 ...
	 *
	 * @param \jinowom\workflow\base\StatusInterface $initalStatus the status used to enter into the workflow (the <i>initial status</i>)
	 * @param Object $sender
	 * @return array
	 */
	 ...
	 *
	 * @param \jinowom\workflow\base\StatusInterface $finalStatus the status that the model last visited in the workflow it is leaving
	 ...
	 *
	 * @param \jinowom\workflow\base\TransitionInterface $transition the transition representing the status
	 * change
	 * @param Object $sender
	 * @return array
	 */
