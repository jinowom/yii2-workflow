...
class WorkflowEvent extends ModelEvent
{
	 ...
	 * 
	 * @return \jinowom\workflow\base\Status the start status involved in this event
	 */
	 ...
	 * 
	 * @return \jinowom\workflow\base\Status the end status involved in this event
	 */
	 ...
	 * 
	 * @return \jinowom\workflow\Transition the transition involved in this event or NULL if no
	 * transition is available (e.g. EnterWorkflow, LeaveWorkflow)
	 * @see \jinowom\workflow\base\Transition
	 */
