<?php
namespace jinowom\workflow\source\file;
...
class WorkflowFileSource extends BaseObject implements IWorkflowSource
{
	 ...
	 */
	const DEFAULT_WDLOADER_CLASS = '\jinowom\workflow\source\file\PhpClassLoader';
	/**
	 *
	 * @var string|array|\jinowom\workflow\source\file\WorkflowDefinitionLoader The workflow definition loader used by this
	 ...
	 *
	 * If this attribute is not set then a default object of type `\jinowom\workflow\source\file\PhpClassLoader` is used.
	 */
	...
	/**
	 * @var \jinowom\workflow\base\WorkflowInterface[] list of workflow instances indexed by workflow id
	 */
	private $_w = [];
	/**
	 * @var \jinowom\workflow\base\StatusInterface[] list status instances indexed by their id
	 */
	private $_s = [];
	/**
	 * @var \jinowom\workflow\base\TransitionInterface[] list of out-going Transition instances indexed by the start status id
	 */
	private $_t = [];
	/**
	 ...
	 *
	 * @see \jinowom\workflow\source\IWorkflowSource::getStatus
	 */
	 ...
	 *
	 * @return jinowom\workflow\base\Workflow|null The workflow instance or NULL if no workflow could be found
	 * @see IWorkflowSource::getTransition()
	 */
	 ...
	 *
	 * @param string $id
	 * @throws \jinowom\workflow\base\WorkflowException the definition could not be loaded
	 */
	 ...
	 * is set to TRUE.
	 *
	 * @see \jinowom\workflow\base\SimpleWorkflowBehavior::attach()
	 ...
	 * 
	 * @see \jinowom\workflow\source\IWorkflowSource::getAllStatuses()
	 */
