...
use jinowom\workflow\base\IStatusAccessor;
...
class ExternalStatusAccessor implements IStatusAccessor
{
	...
	/* (non-PHPdoc)
	 * @see \jinowom\workflow\IStatusAccessor::getStatus()
	 */
	...
	/* (non-PHPdoc)
	 * @see \jinowom\workflow\IStatusAccessor::setStatus()
	 */
	...
	/* (non-PHPdoc)
	 * @see \jinowom\workflow\base\IStatusAccessor::readStatus()
	 */
	...
	/* (non-PHPdoc)
	 * @see \jinowom\workflow\base\IStatusAccessor::updateStatus()
	 */
