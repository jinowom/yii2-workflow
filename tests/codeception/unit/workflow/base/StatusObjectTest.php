...
class StatusObjectTest extends TestCase
{
	...
	public function testUnknownMetadata()
	{
		...
		{
			$this->expectException('jinowom\workflow\base\WorkflowException');
	...
	public function testCreateWithSourceFails1()
	{
		$this->specify('create a status instance with an invalid source component', function ()
		{
			...
			$this->expectException('yii\base\InvalidConfigException');
			$this->expectExceptionMessage('The "source" property must implement interface jinowom\workflow\source\IWorkflowSource');
			$start = new Status([
				'id' => 'draft',
				'workflowId' => 'workflow1',
				'source' => $src
