...
class GetNextStatusTest extends DbTestCase
{
    ...
    public function testGetNextStatusFails()
    {
    	...
    	$this->specify('getNextStatus throws exception if default workflow Id is invalid',function() use ($item) {
				$this->expectException(
					'jinowom\workflow\base\WorkflowException'
	    		);
    ...
    public function testReturnReportWithEventsOnEnterWorkflow()
    {
    	...
    	$this->assertInstanceOf('jinowom\workflow\base\Status', $report['Item04Workflow/A']['status']);
    ...
    public function testReturnReportWithValidation()
    {
    	...
    	$this->assertInstanceOf('jinowom\workflow\base\Status', $report['Item05Workflow/correction']['status']);
    	...
    	$this->assertInstanceOf('jinowom\workflow\base\Status', $report['Item05Workflow/published']['status']);
