...
class TransitionTest extends TestCase
{
    ...
    public function testTransitionSuccess()
    {
    	...
    	$this->specify('end and start status can be obtained',function() {
			...
			verify('transition is a Transition', get_class($transition))->equals('jinowom\workflow\base\Transition');

			verify('start status is a Status instance',get_class($transition->getStartStatus()) )->equals('jinowom\workflow\base\Status');
			verify('start status is A', $transition->getStartStatus()->getId())->equals('wid/A');

			verify('end status is a Status instance',get_class($transition->getStartStatus()) )->equals('jinowom\workflow\base\Status');
