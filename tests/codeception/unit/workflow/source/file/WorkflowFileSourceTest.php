...
class WorkflowFileSourceTest extends TestCase
{
	...
	public function testConstructSuccess()
	{
		$this->specify('Workflow source construct default',function (){
			...
			expect($src->getClassMapByType(WorkflowFileSource::TYPE_WORKFLOW))->equals(	'jinowom\workflow\base\Workflow'		);
			expect($src->getClassMapByType(WorkflowFileSource::TYPE_STATUS))->equals(	'jinowom\workflow\base\Status'		);
			expect($src->getClassMapByType(WorkflowFileSource::TYPE_TRANSITION))->equals('jinowom\workflow\base\Transition'	);
