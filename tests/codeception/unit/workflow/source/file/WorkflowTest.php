...
class WorkflowTest extends TestCase
{
	...
	/**
	 * @expectedException jinowom\workflow\base\WorkflowValidationException
    ...
    public function testLoadMinimalWorkflowSuccess()
    {
    	...
    	$this->specify('can load workflow', function () use ($src) {
    		...
    		verify('a Workflow instance is returned', get_class($w) )->equals('jinowom\workflow\base\Workflow');
